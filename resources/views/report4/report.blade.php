...
@section('title', trans('menu.report4'))
		...
		<div class="row">
	        <div class="col-sm-12">
	          <div class="panel panel-default panel-border-color panel-border-color-primary">
	            <div class="panel-heading panel-heading-divider">{{ trans('common.report') }}<span class="panel-subtitle">{{ trans('menu.report4') }}</span></div>
	            <div class="panel-body">
                <form class="form-horizontal" action="{{ url('report4/getData') }}" method="POST" id="form-add">
                  {{ csrf_field() }}
                  <div class="col-sm-6">
